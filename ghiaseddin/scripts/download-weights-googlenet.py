...
data_zip_path = os.path.join(settings.model_root, "blvc_googlenet.pkl")
data_url = "https://s3.amazonaws.com/lasagne/recipes/pretrained/imagenet/blvc_googlenet.pkl"
